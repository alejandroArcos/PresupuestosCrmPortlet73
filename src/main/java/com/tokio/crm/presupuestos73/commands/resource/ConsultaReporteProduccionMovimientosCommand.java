...
@Component(immediate = true, property = {"javax.portlet.name=" + PresupuestosCrmPortlet73PortletKeys.PRESUPUESTOSCRMPORTLET73,
        "mvc.command.name=/crm/presupuestos/produccion/consultarReporteMovimientos"}, service = MVCResourceCommand.class)
public class ConsultaReporteProduccionMovimientosCommand extends BaseMVCResourceCommand {
    ...
    protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
        ...
        MovimientosProduccion respuesta;
        usuario=(User) resourceRequest.getAttribute(WebKeys.USER);
        Gson gson = new Gson();
        respuesta = _CrmGenericoService.getReporteProduccionMovimientos(area,anio,mes,usuario.getScreenName(),PresupuestosCrmPortlet73PortletKeys.PRESUPUESTOSCRMPORTLET73);
